...
public abstract class ThemeComponentOption implements CustomizationOption<ThemeComponentOption> {
    ...
    public static class PrimaryOption extends ThemeComponentOption {
        ...
        public void bindThumbnailTile(View view) {
            ...
            ShapeDrawable triangleCircle =
                    new TwoTrianglesDrawable(mPrimaryColor, mSecondaryPrimaryColor, true);
            triangleCircle.setIntrinsicHeight(chipSize);
            triangleCircle.setIntrinsicWidth(chipSize);
            StateListDrawable background =
                    (StateListDrawable) triangleCircle.getConstantState().newDrawable();
            ShapeDrawable foreground =
                    (ShapeDrawable) triangleCircle.getConstantState().newDrawable();
