...
public abstract class ThemeComponentOption implements CustomizationOption<ThemeComponentOption> {
    ...
    public static class PrimaryOption extends ThemeComponentOption {
        ...
        public void bindThumbnailTile(View view) {
            ...
            int chipSize = res.getDimensionPixelSize(R.dimen.component_color_chip_size);
            ...
            Drawable stencil = shapeDrawable.getConstantState().newDrawable();
            background.setTintList(res.getColorStateList(R.color.option_border_color, theme));
            ShapeDrawable foreground =
                    (ShapeDrawable) new TwoTrianglesDrawable(mPrimaryColor, mSecondaryPrimaryColor, true);
