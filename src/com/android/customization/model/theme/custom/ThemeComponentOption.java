...
public abstract class ThemeComponentOption implements CustomizationOption<ThemeComponentOption> {
    ...
    public static class ColorOption extends ThemeComponentOption {
        ...
        @Override
        public void bindPreview(ViewGroup container) {
            bindPreviewHeader(container, R.string.preview_name_color_new, R.drawable.ic_colorize_24px);
    ...
    public static class PrimaryOption extends ThemeComponentOption {
        ...
        public void bindThumbnailTile(View view) {
            ...
            int chipSize = res.getDimensionPixelSize(R.dimen.component_color_chip_container_size);

            ShapeDrawable shapeDrawable = new ShapeDrawable(new OvalShape());
            shapeDrawable.setIntrinsicHeight(chipSize);
            shapeDrawable.setIntrinsicWidth(chipSize);
            Drawable background = shapeDrawable.getConstantState().newDrawable();
            // ShapeDrawable foreground = (ShapeDrawable) shapeDrawable.getConstantState().newDrawable();
            ShapeDrawable foreground =
                    (ShapeDrawable) new TwoTrianglesDrawable(mPrimaryColor, mSecondaryPrimaryColor);
            LayerDrawable mShape = new LayerDrawable(new Drawable[]{background, foreground});
            ...
            foreground.setTint(ColorUtils.blendARGB(mPrimaryColor, mSecondaryPrimaryColor, .5f));
